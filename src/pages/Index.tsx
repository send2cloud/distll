...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (path.length > 1) {
      // If there's anything after the root "/"
  ...
  return <div className="min-h-screen font-sans bg-[C2B280] bg-[#e4d5c2]">
      {/* Navigation section */}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <div className="flex gap-2">
                  <Input type="text" placeholder="Enter URL (e.g., example.com/article)" value={url} onChange={handleInputChange} className="flex-1 border-gray-300 focus:border-[#9b87f5] focus:ring-[#9b87f5]" />
                  <Button type="submit" disabled={!isValidUrl} className="bg-[#221F26] hover:bg-[#403E43]">
                    Distill
                  </Button>
                </div>
                <div className="pt-4 py-0 px-[150px]">
                  ...
                  <div className="flex gap-2">
                    <Input type="text" placeholder="Custom style (e.g., clickbait, academic, etc.)" value={customStyle} onChange={handleStyleChange} className="flex-1 border-gray-300" />
                  </div>
                </div>
              </div>
              ...
              <div className="pt-1">
                ...
                <div className="flex flex-wrap gap-2">
                  <Button type="button" variant="outline" size="sm" onClick={() => handleStyleClick('simple')} className="border-[#9b87f5] text-[#403E43] rounded-full">Simple</Button>
                  <Button type="button" variant="outline" size="sm" onClick={() => handleStyleClick('eli5')} className="border-[#9b87f5] text-[#403E43] rounded-full">ELI5</Button>
                  <Button type="button" variant="outline" size="sm" onClick={() => handleStyleClick('clickbait')} className="border-[#9b87f5] text-[#403E43] rounded-full">Clickbait</Button>
                  <Button type="button" variant="outline" size="sm" onClick={() => handleStyleClick('tamil')} className="border-[#9b87f5] text-[#403E43] rounded-full">Tamil</Button>
                  <Button type="button" variant="outline" size="sm" onClick={() => handleStyleClick('executivesummary')} className="border-[#9b87f5] text-[#403E43] rounded-full">Executive Summary</Button>
                  <Button type="button" variant="outline" size="sm" onClick={() => handleStyleClick('5')} className="border-[#9b87f5] text-[#403E43] rounded-full">5 Bullets</Button>
                </div>
              </div>
            </form>
          </CardContent>
